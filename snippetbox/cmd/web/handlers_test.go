	...
	for _, test := range tests {
		t.Run(test.name, func(t *testing.T) {
			...
			if test.name == "authenticated" {
				...
				// Make a POST /user/login request using extracted csrft token and creds from mock user model
				form := url.Values{}
			...
			// authenticated case should have a body, whereas unauthenticated user should get redirected to login page
			if test.name == "authenticated" {
